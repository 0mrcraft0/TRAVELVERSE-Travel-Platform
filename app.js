...
const navigationStyle=document.createElement('style');navigationStyle.textContent='.site-header{position:relative!important;top:auto!important;left:auto!important;width:auto!important;background:var(--cream)!important;border-bottom:0!important;backdrop-filter:none!important}main{padding-top:0!important}@media(max-width:800px){.site-header{height:68px}.main-nav{position:absolute;top:100%;left:0;right:0;margin-left:0;padding:0 7vw;background:var(--cream);border-bottom:1px solid var(--line);display:flex;flex-direction:column;gap:0;overflow:hidden;max-height:0;opacity:0;transform:translateY(-16px);pointer-events:none;transition:max-height .35s ease,opacity .25s ease,transform .35s ease}.site-header.menu-open .main-nav{max-height:280px;opacity:1;transform:translateY(0);pointer-events:auto}.main-nav a{padding:18px 0;border-bottom:1px solid var(--line)}.main-nav a.active:after{display:none}}';document.head.appendChild(navigationStyle);
